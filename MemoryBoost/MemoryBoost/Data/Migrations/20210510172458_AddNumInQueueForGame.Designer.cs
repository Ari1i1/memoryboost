...
namespace MemoryBoost.Data.Migrations
{
    ...
    [Migration("20210510172458_AddNumInQueueForGame")]
    partial class AddNumInQueueForGame
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemoryBoost.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MemoryBoost.Models.GameLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("SecForMemorizing")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MemoryBoost.Models.Game", b =>
                {
                    b.HasOne("MemoryBoost.Models.GameLevel", "Level")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MemoryBoost.Models.ApplicationUser", null)
                        .WithMany()
